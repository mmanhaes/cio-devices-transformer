...
class CustomTransformerFS_V2(BaseEstimator,TransformerMixin):
    ...
    def transform(self, X, y = None):
        ...
        X_['mdm_disk_free_space'] = X_['mdm_disk_free_space'].replace(0.0,X_['mdm_disk_free_space'].value_counts().idxmax())
        X_['mdm_disk_size'] = X_['mdm_disk_size'].replace(0.0,X_['mdm_disk_size'].value_counts().idxmax())
